...
import TypingAnimationAbout from "./TypingAnimationAbout";
const About = () => {
              ...
              <div className="title w-full float-left mb-[40px]">
                ...
                <span className="job font-semibold text-[20px] text-dark-color">
                  <span className="cd-headline rotate-1">
                    ...
                    <span className="blc">Front-End Engineer, specialized in </span>
                    <TypingAnimationAbout />
                  </span>
                </span>
              </div>
              <div className="elisc_tm_button transition_link">
                <a href="#contact" onClick={() => navChange("contact")}>Got a project?</a>
              </div>
            </div>
            <div className="right w-[60%]">
              <div className="text w-full float-left mb-[44px]">
                <p className="mb-[30px]">
                  ...
                  <span className="text-yellow-color">Mario Alvarez</span>. I am
                  a web designer &amp; developer, and I'm very passionate and
                  dedicated to my work.
                </p>
                <p>
                  With 3 years experience as a professional software engineer and marketer,
              ...
              <div className="info w-full float-left">
                <ul>
                  ...
                  <li className="mr-[40px] mb-[20px] inline-block">
                    ...
                    <span className="block font-inter font-bold text-dark-color">
                      <a href="mailto:mariofalvarezjr@gmail.com">mariofalvarezjr@gmail.com</a>
                    </span>
                  </li>
                  <li className="mr-[40px] mb-[20px] inline-block">
                    <span className="block uppercase underline">Phone</span>
                    <span className="block font-inter font-bold text-dark-color">
                      <a href="tel:+77 022 444 05 05">(650) 931-5933</a>
                    </span>
                  </li>
                </ul>
              </div>
